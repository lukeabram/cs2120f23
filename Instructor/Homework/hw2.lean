...
#eval implies true false   -- expected to be false
#eval implies true true -- expected to be true
#eval implies false false -- expected to be true
#eval implies false true -- expected to be true
