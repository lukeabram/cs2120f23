...
Answer here: x is left associative, it only makes a
difference when applied to arguments on the left of a statement.
...
-- Here:
#eval first (triple 13 "Luke" true)
#eval second (triple 13 "Luke" true)
#eval third (triple 13 "Luke" true)
